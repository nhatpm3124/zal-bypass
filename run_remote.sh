...
show_menu() {
    ...
    echo ""
    echo -e "${CYAN}"
    echo " ____  _   _  ___  _   _ _____    ____  _____    _    ____   ____ _   _ "
    echo "|  _ \\| | | |/ _ \\| \\ | | ____|  / ___|| ____|  / \\  |  _ \\ / ___| | | |"
    echo "| |_) | |_| | | | |  \\| |  _|    \\___ \\|  _|   / _ \\ | |_) | |   | |_| |"
    echo "|  __/|  _  | |_| | |\\  | |___    ___) | |___ / ___ \\|  _ <| |___|  _  |"
    echo "|_|   |_| |_|\\___/|_| \\_|_____|  |____/|_____/_/   \\_\\_| \\_\\\\____|_| |_|"
    echo -e "${NC}"
    echo ""
    ...
    echo -e "${CYAN}  ${YELLOW}3)${NC} ${GREEN}Config Mode${NC}         ${BLUE}(create config file)${NC}"
